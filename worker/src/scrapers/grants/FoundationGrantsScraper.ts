...
import type { GrantStatus } from "../../types.js";
...
const KNOWN_GRANTS: GrantSource[] = [
  ...
  },
  {
    ...
    logoUrl: "https://linea.build/favicon.ico",
    grants: [
      {
  ...
  },
  {
    ...
    logoUrl: "https://www.starknet.io/wp-content/uploads/2024/01/starknet-icon.svg",
    grants: [
      {
  ...
  },
  {
    ...
    chain: "Blast",
    url: "https://blast.io/",
    logoUrl: "https://blast.io/images/logo-circle.svg",
    grants: [
      {
        name: "Blast Big Bang",
        slug: "blast-bigbang",
  ...
  },
  {
    ...
    logoUrl: "https://www.mode.network/favicon.ico",
    grants: [
      {
        name: "Mode Grants",
        slug: "mode-grants",
  ...
  },
  {
    ...
    logoUrl: "https://cryptologos.cc/logos/moonbeam-glmr-logo.png",
    grants: [
      {
  ...
  },
  {
    ...
    chain: "Taiko",
    url: "https://taiko.xyz/",
    logoUrl: "https://taiko.xyz/images/logo-icon.svg",
    grants: [
      {
        name: "Taiko Grants",
        slug: "taiko-grants",
  ...
  },
  {
    ...
    logoUrl: "https://www.zetachain.com/logo.svg",
    grants: [
      {
